...
dataset_pe = pandas.read_excel(url, sheet_name="pe-no-decimal", names=names)
...
print ("Finalisate model evaluation")
...
print("Accuracy score of CART: ", accuracy_score(Y_validation, predictions))
